...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val ERROR_KEY = "ERROR_KEY" // ✅ Tambahan sesuai instruksi
    }

    // ✅ Handler untuk menerima hasil dari ResultActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submitButton.setOnClickListener {
            ...
            // ✅ Validasi input sesuai instruksi modul
            if (colorCode.isNotEmpty()) {
                if (colorCode.length < 6) {
                    ...
                    // ✅ Gunakan startForResult, bukan startActivity
